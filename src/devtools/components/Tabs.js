                    ...
                    {#list source as s}
                        {#if s.key === "data" }
                          <div class="mdl-tooltip roboto" data-mdl-for="ttl2">
                            the data displayed here is passed from inspected page by IPC, which means only JSON-ifiable object is allowed. If you want to inspect DOM or function in data, please use $r in console
                          </div>
