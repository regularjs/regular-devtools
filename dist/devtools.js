    ...
    editDone: function(e) {
        ...
        while (parent) {
            if (parent.name === 'jsonTree') {
                parent.$emit('change', {
                    path: this$1.data.path,
                    value: tmp,
                    oldValue: this$1.data.value
                });
                break;
            }
...
devtools
    .$on("initNodes", function(nodesStr) {
        ...
        var nodes = CircularJSON.parse(nodesStr);
